...
<head>
  ...
  <title>Graduation Bouquet</title>
...
<body>
  ...
  <section class="hero-section ceremony-page">
    <h2 class="glow" style="padding-top: 50px; padding-bottom: 30px;"> Graduation Bouquet</h2>
  </section>
  ...
  <section class="ceremony-details ceremony-page">
    <div class="row justify-content-center" id="product-list">
      ...
      <div class="col-md-4 mb-4 d-flex product-card" data-name="graduation">
        <div class="card flex-fill">
          <img src="images/graduation-bouquet.jpg" class="card-img-top" alt="graduation Bouquet">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title flex-grow-1">Graduation Bouquet</h5>
