...
<head>
  ...
  <title>Anniversary Bouquet</title>
...
<body>
  ...
  <section class="hero-section ceremony-page">
    <h2 class="glow" style="padding-top: 50px; padding-bottom: 30px;"> Anniversary Bouquet</h2>
  </section>
  ...
  <section class="ceremony-details ceremony-page">
    <div class="row justify-content-center" id="product-list">
      ...
      <div class="col-md-4 mb-4 d-flex product-card" data-name="anniversary">
        <div class="card flex-fill">
          <img src="images/anniversary-bouquet.jpg" class="card-img-top" alt="anniversary Bouquet">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title flex-grow-1">Anniversary Bouquet</h5>
