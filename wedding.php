...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="w3-lobster" href="index.html">Blooming Boutique</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mr-auto" style="font-weight: bold;">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.html#products">Bouquets</a>
        </li>
        <li class="nav-item">
  ...
  <section class="hero-section ceremony-page">
    <h2 class="glow" style="padding-top: 50px; padding-bottom: 30px;"> Wedding Bouquet</h2>
  </section>
  ...
  <section class="ceremony-details ceremony-page">
    <div class="row justify-content-center" id="product-list">
      <!-- Column for Product 1 -->
            <div class="col-md-4 mb-4 d-flex product-card" data-name="wedding">
              <div class="card flex-fill">
        <img src="images/wedding-bouquet.jpg" class="card-img-top" alt="wedding Bouquet">
        <div class="card-body d-flex flex-column">
          <h5 class="card-title flex-grow-1">Wedding Bouquet</h5>
...
<div id="about-modal" class="modal">
  <div class="modal-content">
    ...
    <p>Blooming Boutique is a family-owned business offering the freshest and most beautiful flower arrangements for all occasions. Our expert florists craft each bouquet with care and attention to detail, ensuring that every arrangement is perfect for your special moments.</p>
  </div>
</div>
